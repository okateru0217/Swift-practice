...
class BottomControlView: UIView {
    ...
    let reloadView = BottomButotnView(frame: .zero, width: 50, imageName: "reload")
    let nopeView = BottomButotnView(frame: .zero, width: 60, imageName: "nope")
    let superlikeView = BottomButotnView(frame: .zero, width: 50, imageName: "superlike")
    let likeView = BottomButotnView(frame: .zero, width: 60, imageName: "like")
    let boostView = BottomButotnView(frame: .zero, width: 50, imageName: "boost")
